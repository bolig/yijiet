...
package com.yijiet.lib.view.list;
    ...
    private AnimationListener mRefreshListener = new AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                ...
                if (mNotify) {
                    if (mListener != null) {
                        mListener.onRefresh(SwipyRefreshLayout.this, mDirection);
                    }
                }
            } else {
                mProgress.stop();
...
//        }
    ...
    public interface OnRefreshListener {
        void onRefresh(SwipyRefreshLayout layout, SwipyRefreshLayoutDirection direction);
    }
