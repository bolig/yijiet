...
public class RoundRectDrawable extends Drawable {
    ...
    private void updateBounds(Rect bounds) {
        ...
        mBoundsI.set(bounds);
        if (mInsetForPadding) {
            float vInset = ShadowDrawable.calculateVerticalPadding(mPadding, mRadius, mInsetForRadius);
            float hInset = ShadowDrawable.calculateHorizontalPadding(mPadding, mRadius, mInsetForRadius);
