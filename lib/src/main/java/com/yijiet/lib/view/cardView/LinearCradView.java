 ...
 * last: ...
 */
public class LinearCradView extends LinearLayout implements CardViewDelegate {
    ...
    public LinearCradView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public LinearCradView(Context context, AttributeSet attrs, int defStyleAttr) {
