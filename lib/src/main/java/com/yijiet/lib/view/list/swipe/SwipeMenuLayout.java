package com.yijiet.lib.view.list.swipe;
...
public class SwipeMenuLayout extends FrameLayout {
    ...
    private OnMenuStatChangeListener mStatChangeListener;
    private OnSrcollChangeListener mSrcollChangeListener;
    ...
    private void swipe(int dis) {
        ...
        if (mSrcollChangeListener != null) {
            mSrcollChangeListener.onSrcollChange(mContentView, dis, mMenuView.getWidth());
        }
    ...
    public void smoothCloseMenu() {
        state = STATE_CLOSE;
        if (mStatChangeListener != null) {
            mStatChangeListener.onStatChange(isOpen());
        }
    ...
    public void setOnMenuChangeListener(OnMenuStatChangeListener listener) {
        this.mStatChangeListener = listener;
    }

    public void setOnSrcollChangeListener(OnSrcollChangeListener listener) {
        this.mSrcollChangeListener = listener;
    }

    public interface OnMenuStatChangeListener {
        void onStatChange(boolean isOpen);
    }

    public interface OnSrcollChangeListener {

        void onSrcollChange(View root, int currentProgess, int totalProgress);
    }
}
