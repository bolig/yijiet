...
////                center
    ...
    public void initialize(CardViewDelegate cardView, Context context, int backgroundColor,
        ...
        ShadowDrawable background = createBackground(context, backgroundColor, radius,
    ...
    ShadowDrawable createBackground(Context context, int backgroundColor,
                                    float radius, float elevation, float maxElevation) {
        return new ShadowDrawable(context.getResources(), backgroundColor, radius,
                elevation, maxElevation);
    }
    ...
    private ShadowDrawable getShadowBackground(CardViewDelegate cardView) {
        return ((ShadowDrawable) cardView.getBackground());
    }
}
